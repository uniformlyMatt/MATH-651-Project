...
''' This script takes in a binary image, fills all connected components,
and saves each connected component as an individual .png file. '''
...
def CreateTestingSet(filepath, filename, subsize):
    def rgb2gray(rgb):
    ...
    # Now create a (subsize x subsize) subimage for each object in the original image.
